...
<Playground>
  <CRow className="mb-3">
    ...
    <div className="col-sm-10">
      <CFormControl type="text" id="staticEmail" value="email@example.com" readOnly plainText/>
    </div>
  </CRow>
  <CRow className="mb-3">
...
<Playground>
  <CForm class="row g-3">
    <div class="col-auto">
      ...
      <CFormControl type="text" id="staticEmail2" value="email@example.com" readOnly plainText/>
    </div>
    <div class="col-auto">
...
<Playground>
  ...
  <CFormControl type="color" id="exampleColorInput" value="#563d7c" title="Choose your color" />
</Playground>
