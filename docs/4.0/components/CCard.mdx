...
<Playground>
  <CCard style={{width: '18rem'}}>
    <CCardImage orientation="top" src="/public/images/react.jpg" />
    <CCardBody>
...
<Playground>
  ...
  <CCard className="mb-3">
    ...
    <CCardImage orientation="bottom" src="/public/images/react.jpg" />
  </CCard>
</Playground>
...
<Playground>
  <CCard className="mb-3 bg-dark text-white">
    <CCardImage src="/public/images/react.jpg" />
    <CCardImageOverlay>
      <CCardTitle>Card title</CCardTitle>
      <CCardText>This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</CCardText>
...
<Playground>
  <CCard className="mb-3" style={{ maxWidth: '540px'}}>
    <CRow className="g-0">
      <CCol md={4}>
        <CCardImage src="/public/images/react400.jpg" />
      </CCol>
      <CCol md={8}>
        <CCardBody>
          <CCardTitle>Card title</CCardTitle>
