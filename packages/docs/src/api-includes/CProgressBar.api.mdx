...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="cprogressbar-class-name">
        <td className="text-primary fw-semibold">className<a href="#cprogressbar-class-name" aria-label="CProgressBar className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
