...
<Example code={FormSwitchExampleRaw} name="FormSwitchExample" componentName="React Switch Input">
...
<Example code={FormSwitchReverseExampleRaw} name="FormSwitchReverseExample" componentName="React Switch Input">
