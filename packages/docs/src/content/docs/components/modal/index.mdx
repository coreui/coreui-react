...
<Example code={ModalLiveDemoExampleRaw} lang="tsx" name="ModalLiveDemoExample" componentName="React Modal">
...
<Example code={ModalStaticBackdropExampleRaw} lang="tsx" name="ModalStaticBackdropExample" componentName="React Modal">
...
<Example code={ModalScrollingLongContentExampleRaw} lang="tsx" name="ModalScrollingLongContentExample" componentName="React Modal">
...
<Example code={ModalScrollingLongContent2ExampleRaw} lang="tsx" name="ModalScrollingLongContent2Example" componentName="React Modal">
...
<Example code={ModalVerticallyCenteredExampleRaw} lang="tsx" name="ModalVerticallyCenteredExample" componentName="React Modal">
  <ModalVerticallyCenteredExample client:only="react" />
</Example>

<Example code={ModalVerticallyCenteredScrollableExampleRaw} lang="tsx" name="ModalVerticallyCenteredScrollableExample" componentName="React Modal">
...
<Example code={ModalTooltipsAndPopoversExampleRaw} lang="tsx" name="ModalTooltipsAndPopoversExample" componentName="React Modal">
...
<Example code={ModalToggleBetweenModalsExampleRaw} lang="tsx" name="ModalToggleBetweenModalsExample" componentName="React Modal">
...
<Example code={ModalOptionalSizesExampleRaw} lang="tsx" name="ModalOptionalSizesExample" componentName="React Modal">
...
<Example code={ModalFullscreenExampleRaw} lang="tsx" name="ModalFullscreenExample" componentName="React Modal">
