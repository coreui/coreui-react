...
<Example code={TabsExampleRaw} name="TabsExample" componentName="React Tabs">
...
<Example code={TabsUnstyledExampleRaw} name="TabsUnstyledExample" componentName="React Tabs">
...
<Example code={TabsPillsExampleRaw} name="TabsPillsExample" componentName="React Tabs">
...
<Example code={TabsUnderlineExampleRaw} name="TabsUnderlineExample" componentName="React Tabs">
...
<Example code={TabsUnderlineBorderExampleRaw} name="TabsUnderlineBorderExample" componentName="React Tabs">
...
<Example code={TabsEnclosedExampleRaw} name="TabsEnclosedExample" componentName="React Tabs">
...
<Example code={TabsEnclosedPillsExampleRaw} name="TabsEnclosedPillsExample" componentName="React Tabs">
...
<Example code={TabsUnstyledFillAndJustifyExampleRaw} name="TabsUnstyledFillAndJustifyExample" componentName="React Tabs">
...
<Example code={TabsUnstyledFillAndJustify2ExampleRaw} name="TabsUnstyledFillAndJustify2Example" componentName="React Tabs">
...
<Example code={TabsControlledExampleRaw} codeJs={TabsControlledExampleJsRaw} name="TabsControlledExample" componentName="React Tabs">
