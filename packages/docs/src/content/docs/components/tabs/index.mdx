...
import { TabsEnclosedExample } from './examples/TabsEnclosedExample'
import TabsEnclosedExampleRaw from './examples/TabsEnclosedExample.tsx?raw'
import { TabsEnclosedPillsExample } from './examples/TabsEnclosedPillsExample'
import TabsEnclosedPillsExampleRaw from './examples/TabsEnclosedPillsExample.tsx?raw'
...
<Example code={TabsExampleRaw} lang="tsx" name="TabsExample" componentName="React Tabs">
...
<Example code={TabsUnstyledExampleRaw} lang="tsx" name="TabsUnstyledExample" componentName="React Tabs">
...
<Example code={TabsPillsExampleRaw} lang="tsx" name="TabsPillsExample" componentName="React Tabs">
...
<Example code={TabsUnderlineExampleRaw} lang="tsx" name="TabsUnderlineExample" componentName="React Tabs">
...
<Example code={TabsUnderlineBorderExampleRaw} lang="tsx" name="TabsUnderlineBorderExample" componentName="React Tabs">
...
<Example code={TabsEnclosedExampleRaw} lang="tsx" name="TabsEnclosedExample" componentName="React Tabs">
  <TabsEnclosedExample client:only="react" />
</Example>
...
<Example code={TabsEnclosedPillsExampleRaw} lang="tsx" name="TabsEnclosedPillsExample" componentName="React Tabs">
  <TabsEnclosedPillsExample client:only="react" />
</Example>
...
<Example code={TabsUnstyledFillAndJustifyExampleRaw} lang="tsx" name="TabsUnstyledFillAndJustifyExample" componentName="React Tabs">
...
<Example code={TabsUnstyledFillAndJustify2ExampleRaw} lang="tsx" name="TabsUnstyledFillAndJustify2Example" componentName="React Tabs">
...
<Example code={TabsControlledExampleRaw} codeJs={TabsControlledExampleJsRaw} lang="tsx" name="TabsControlledExample" componentName="React Tabs">
