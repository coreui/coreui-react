...
<Example code={FocusTrapBasicExampleRaw} name="FocusTrapBasicExample" componentName="React Focus Trap">
...
<Example code={FocusTrapModalExampleRaw} name="FocusTrapModalExample" componentName="React Focus Trap Modal">
...
<Example code={FocusTrapDropdownExampleRaw} name="FocusTrapDropdownExample" componentName="React Focus Trap Dropdown">
...
<Example code={FocusTrapSidebarExampleRaw} name="FocusTrapSidebarExample" componentName="React Focus Trap Sidebar">
...
<Example code={FocusTrapFocusControlExampleRaw} name="FocusTrapFocusControlExample" componentName="React Focus Trap Focus Control">
...
<Example code={FocusTrapRestoreFocusExampleRaw} name="FocusTrapRestoreFocusExample" componentName="React Focus Trap Restore Focus">
...
<Example code={FocusTrapEventsExampleRaw} codeJs={FocusTrapEventsExampleJsRaw} name="FocusTrapEventsExample" componentName="React Focus Trap Events">
...
<Example code={FocusTrapConditionalExampleRaw} name="FocusTrapConditionalExample" componentName="React Focus Trap Conditional">
