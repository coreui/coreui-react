...
<Example code={AccordionExampleRaw} name="AccordionExample" componentName="React Bootstrap Accordion" class="theme-bootstrap">
...
<Example code={AccordionFlushExampleRaw} name="AccordionFlushExample" componentName="React Bootstrap Accordion" class="theme-bootstrap">
...
<Example code={AccordionAlwaysOpenExampleRaw} name="AccordionAlwaysOpenExample" componentName="React Bootstrap Accordion" class="theme-bootstrap">
