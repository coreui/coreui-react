...
<Example code={SearchButtonExampleRaw} name="SearchButtonExample" componentName="React Search Button">
...
<Example code={SearchButtonCustomShortcutExampleRaw} name="SearchButtonCustomShortcutExample" componentName="React Search Button">
...
<Example code={SearchButtonOffcanvasExampleRaw} name="SearchButtonOffcanvasExample" componentName="React Search Button">
