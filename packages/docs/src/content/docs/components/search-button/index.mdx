...
<Example code={SearchButtonExampleRaw} lang="tsx" name="SearchButtonExample" componentName="React Search Button">
...
<Example code={SearchButtonCustomShortcutExampleRaw} lang="tsx" name="SearchButtonCustomShortcutExample" componentName="React Search Button">
...
<Example code={SearchButtonOffcanvasExampleRaw} lang="tsx" name="SearchButtonOffcanvasExample" componentName="React Search Button">
