...
import CalloutExampleRaw from './examples/CalloutExample.tsx?raw'
...
<Example code={CalloutExampleRaw} lang="tsx" name="CalloutExample" componentName="React Callout">
  <CalloutExample client:only="react" />
</Example>
