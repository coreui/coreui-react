...
<Example code={ButtonExampleRaw} name="ButtonExample" componentName="React Button">
...
<Example code={ButtonComponentsExampleRaw} name="ButtonComponentsExample" componentName="React Button">
...
<Example code={ButtonOutlineBaseClassExampleRaw} name="ButtonOutlineBaseClassExample" componentName="React Button">
...
<Example code={ButtonOutlineExampleRaw} name="ButtonOutlineExample" componentName="React Button">
...
<Example code={ButtonGhostBaseClassExampleRaw} name="ButtonGhostBaseClassExample" componentName="React Button">
...
<Example code={ButtonGhostExampleRaw} name="ButtonGhostExample" componentName="React Button">
...
<Example code={ButtonSizes2ExampleRaw} name="ButtonSizes2Example" componentName="React Button">
  <ButtonSizes2Example client:only="react" />
</Example>

You can even roll your own custom sizing with CSS variables:

<Example code={ButtonSizes3ExampleRaw} codeJs={ButtonSizes3ExampleJsRaw} name="ButtonSizes3Example" componentName="React Button">
...
<Example code={ButtonShapePillExampleRaw} name="ButtonShapePillExample" componentName="React Button">
  <ButtonShapePillExample client:only="react" />
</Example>

### Square buttons

<Example code={ButtonShapeSquareExampleRaw} name="ButtonShapeSquareExample" componentName="React Button">
...
<Example code={ButtonDisabledExampleRaw} name="ButtonDisabledExample" componentName="React Button">
...
<Example code={ButtonDisabled2ExampleRaw} name="ButtonDisabled2Example" componentName="React Button">
...
<Example code={ButtonBlockExampleRaw} name="ButtonBlockExample" componentName="React Button">
  <ButtonBlockExample client:only="react" />
</Example>

Here we create a responsive variation, starting with vertically stacked buttons until the `md` breakpoint, where `.d-md-block` replaces the `.d-grid` class, thus nullifying the `gap-2` utility. Resize your browser to see them change.

<Example code={ButtonBlock2ExampleRaw} name="ButtonBlock2Example" componentName="React Button">
  <ButtonBlock2Example client:only="react" />
</Example>

You can adjust the width of your block buttons with grid column width classes. For example, for a half-width "block button", use `.col-6`. Center it horizontally with `.mx-auto`, too.

<Example code={ButtonBlock3ExampleRaw} name="ButtonBlock3Example" componentName="React Button">
