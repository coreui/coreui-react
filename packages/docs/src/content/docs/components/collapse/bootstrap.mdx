...
<Example code={CollapseExampleRaw} lang="tsx" name="CollapseExample" componentName="React Bootstrap Collapse" class="theme-bootstrap">
...
<Example code={CollapseHorizontalExampleRaw} lang="tsx" name="CollapseHorizontalExample" componentName="React Bootstrap Collapse" class="theme-bootstrap">
...
<Example code={CollapseMultipleTargetsExampleRaw} lang="tsx" name="CollapseMultipleTargetsExample" componentName="React Bootstrap Collapse" class="theme-bootstrap">
