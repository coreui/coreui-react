...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="cdropdowntoggle-class-name">
        <td className="text-primary fw-semibold">className<a href="#cdropdowntoggle-class-name" aria-label="CDropdownToggle className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
      ...
      <tr id="cdropdowntoggle-nav-link">
        <td className="text-primary fw-semibold">navLink<a href="#cdropdowntoggle-nav-link" aria-label="CDropdownToggle navLink permalink" className="anchor-link after">#</a><span className="badge bg-success">5.0.0+</span></td>
        <td><code>{`true`}</code></td>
        <td><code>{`boolean`}</code></td>
      </tr>
      <tr>
