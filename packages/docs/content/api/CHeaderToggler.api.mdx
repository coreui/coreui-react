...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cheadertoggler-class-name">
        <td className="text-primary fw-semibold">className<a href="#cheadertoggler-class-name" aria-label="CHeaderToggler className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
