...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="coffcanvasheader-class-name">
        <td className="text-primary fw-semibold">className<a href="#coffcanvasheader-class-name" aria-label="COffcanvasHeader className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
