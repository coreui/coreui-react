...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="cnavitem-class-name">
        <td className="text-primary fw-semibold">className<a href="#cnavitem-class-name" aria-label="CNavItem className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
