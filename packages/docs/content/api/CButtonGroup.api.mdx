...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cbuttongroup-class-name">
        <td className="text-primary fw-semibold">className<a href="#cbuttongroup-class-name" aria-label="CButtonGroup className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
