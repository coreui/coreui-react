...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cheaderbrand-as">
        <td className="text-primary fw-semibold">as<a href="#cheaderbrand-as" aria-label="CHeaderBrand as permalink" className="anchor-link after">#</a></td>
        <td>-</td>
      ...
      <tr id="cheaderbrand-class-name">
        <td className="text-primary fw-semibold">className<a href="#cheaderbrand-class-name" aria-label="CHeaderBrand className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
