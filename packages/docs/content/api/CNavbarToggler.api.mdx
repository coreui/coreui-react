...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cnavbartoggler-class-name">
        <td className="text-primary fw-semibold">className<a href="#cnavbartoggler-class-name" aria-label="CNavbarToggler className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
