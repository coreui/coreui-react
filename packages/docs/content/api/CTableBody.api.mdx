...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ctablebody-class-name">
        <td className="text-primary fw-semibold">className<a href="#ctablebody-class-name" aria-label="CTableBody className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
