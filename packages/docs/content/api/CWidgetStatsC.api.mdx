...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cwidgetstatscwidgetstatsc-className">
        <td className="text-primary fw-semibold">className<a href="#cwidgetstatscwidgetstatsc-className" aria-label="CWidgetStatsCWidgetStatsC className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
