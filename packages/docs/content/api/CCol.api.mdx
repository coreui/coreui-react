...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ccol-className">
        <td className="text-primary fw-semibold">className<a href="#ccol-className" aria-label="CCol className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
