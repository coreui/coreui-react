...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="csidebarbrand-class-name">
        <td className="text-primary fw-semibold">className<a href="#csidebarbrand-class-name" aria-label="CSidebarBrand className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
