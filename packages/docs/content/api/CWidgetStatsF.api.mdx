...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cwidgetstatsf-class-name">
        <td className="text-primary fw-semibold">className<a href="#cwidgetstatsf-class-name" aria-label="CWidgetStatsF className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
