...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="csidebarheader-className">
        <td className="text-primary fw-semibold">className<a href="#csidebarheader-className" aria-label="CSidebarHeader className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
