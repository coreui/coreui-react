...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cheader-class-name">
        <td className="text-primary fw-semibold">className<a href="#cheader-class-name" aria-label="CHeader className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
