...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ctoaster-class-name">
        <td className="text-primary fw-semibold">className<a href="#ctoaster-class-name" aria-label="CToaster className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
