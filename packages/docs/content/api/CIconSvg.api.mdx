...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ciconsvg-class-name">
        <td className="text-primary fw-semibold">className<a href="#ciconsvg-class-name" aria-label="CIconSvg className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
      ...
      <tr id="ciconsvg-custom-class-name">
        <td className="text-primary fw-semibold">customClassName<a href="#ciconsvg-custom-class-name" aria-label="CIconSvg customClassName permalink" className="anchor-link after">#</a></td>
        <td>-</td>
