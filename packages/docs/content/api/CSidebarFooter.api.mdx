...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="csidebarfooter-class-name">
        <td className="text-primary fw-semibold">className<a href="#csidebarfooter-class-name" aria-label="CSidebarFooter className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
