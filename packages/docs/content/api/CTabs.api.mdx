...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ctabs-activeItemKey">
        <td className="text-primary fw-semibold">activeItemKey<a href="#ctabs-activeItemKey" aria-label="CTabs activeItemKey permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
