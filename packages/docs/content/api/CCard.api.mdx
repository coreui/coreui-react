...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ccard-className">
        <td className="text-primary fw-semibold">className<a href="#ccard-className" aria-label="CCard className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
