...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cbuttontoolbar-class-name">
        <td className="text-primary fw-semibold">className<a href="#cbuttontoolbar-class-name" aria-label="CButtonToolbar className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
