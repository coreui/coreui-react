...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cdropdowndivider-className">
        <td className="text-primary fw-semibold">className<a href="#cdropdowndivider-className" aria-label="CDropdownDivider className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
