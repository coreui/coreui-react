...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cprogressstacked-class-name">
        <td className="text-primary fw-semibold">className<a href="#cprogressstacked-class-name" aria-label="CProgressStacked className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
