...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="cwidgetstatsa-class-name">
        <td className="text-primary fw-semibold">className<a href="#cwidgetstatsa-class-name" aria-label="CWidgetStatsA className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
