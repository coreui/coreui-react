...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="ccardimageoverlay-className">
        <td className="text-primary fw-semibold">className<a href="#ccardimageoverlay-className" aria-label="CCardImageOverlay className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
