...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="cnavbarnav-class-name">
        <td className="text-primary fw-semibold">className<a href="#cnavbarnav-class-name" aria-label="CNavbarNav className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
