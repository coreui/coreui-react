...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      ...
      <tr id="cbreadcrumbitem-class-name">
        <td className="text-primary fw-semibold">className<a href="#cbreadcrumbitem-class-name" aria-label="CBreadcrumbItem className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
