...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cnavbartext-class-name">
        <td className="text-primary fw-semibold">className<a href="#cnavbartext-class-name" aria-label="CNavbarText className permalink" className="anchor-link after">#</a></td>
        <td>undefined</td>
