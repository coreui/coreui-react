...
<div className="table-responsive table-api border rounded mb-3">
  <table className="table">
    ...
    <tbody>
      <tr id="cwidgetcwidgetstatsb-class-name">
        <td className="text-primary fw-semibold">className<a href="#cwidgetcwidgetstatsb-class-name" aria-label="CWidgetCWidgetStatsB className permalink" className="anchor-link after">#</a></td>
        <td>-</td>
