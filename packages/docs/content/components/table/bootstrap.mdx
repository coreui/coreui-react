...
<ExampleSnippet component="TableExample" componentName="React Table" />
...
<Example className="theme-bootstrap">
  <TableExample color="dark" striped />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample color="dark" stripedColumns />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample color="success" striped />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample color="success" stripedColumns />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample bordered borderColor="primary" />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample borderless color="dark" />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample tableHeadProps={{ color: 'light' }} />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample tableHeadProps={{ color: 'dark' }} />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample caption="List of users" />
</Example>
...
<Example className="theme-bootstrap">
  <TableExample captionTop="List of users" />
</Example>
