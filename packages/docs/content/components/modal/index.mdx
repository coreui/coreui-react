...
<ExampleSnippet component="ModalStaticBackdropExample" componentName="React Modal" />

### Scrolling long content

When modals become too long for the user's viewport or device, they scroll independent of the page itself. Try the demo below to see what we mean.

<ExampleSnippet component="ModalScrollingLongContentExample" componentName="React Modal" />

You can also create a scrollable react modal component that allows scroll the modal body by adding `scrollable` prop.

<ExampleSnippet component="ModalScrollingLongContent2Example" componentName="React Modal" />

### Vertically centered

Add `alignment="center` to `<CModal>` to vertically center the React modal.

<ExampleSnippet component="ModalVerticallyCenteredExample" componentName="React Modal" />

<ExampleSnippet component="ModalVerticallyCenteredScrollableExample" componentName="React Modal" />
...
<ExampleSnippet component="ModalTooltipsAndPopoversExample" componentName="React Modal" />
...
<ExampleSnippet component="ModalToggleBetweenModalsExample" componentName="React Modal" />
...
<ExampleSnippet component="ModalOptionalSizesExample" componentName="React Modal" />
...
<ExampleSnippet component="ModalFullscreenExample" componentName="React Modal" />
