...
var CCollapse = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CSSTransition$1, { in: visible, timeout: 350, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, function (state) {
...
var CAlert = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CSSTransition$1, { in: _visible, timeout: 150, onExit: onDismiss, onExited: onDismissed, unmountOnExit: true },
...
var CBackdrop = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CSSTransition$1, { in: visible, timeout: 150, mountOnEnter: true, unmountOnExit: true }, function (state) {
        var transitionClass = getTransitionClass(state);
...
var CCarouselItem = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CSSTransition$1, { timeout: 600, in: isIn, onEnter: onEnter, onEntering: onEntering, onExit: onExit, onExiting: onExiting, onExited: onExited, nodeRef: ref }, function (status) {
...
var CModal = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("div", { onClick: handleDismiss, onKeyDown: handleKeyDown },
            React__default['default'].createElement(CSSTransition$1, { in: visible, timeout: !transition ? 0 : duration, onExit: onDismiss, mountOnEnter: true, unmountOnExit: true }, function (state) {
                var transitionClass = getTransitionClass(state);
...
var CNavGroup = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("li", __assign({ className: _className }, rest, { ref: ref }),
        ...
        React__default['default'].createElement(Transition$1, { in: _visible, timeout: 300, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, function (state) { return (React__default['default'].createElement("ul", { className: "nav-group-items", style: __assign(__assign({}, style), transitionStyles[state]), ref: navItemsRef }, React__default['default'].Children.map(children, function (child, index) {
            if (React__default['default'].isValidElement(child)) {
...
var CPopover = function (_a) {
    ...
    return (React__default['default'].createElement(Manager, null,
        ...
        typeof window !== 'undefined' &&
            ReactDOM.createPortal(React__default['default'].createElement(CSSTransition$1, { in: _visible, timeout: {
                    enter: 0,
                    exit: 200,
...
var COffcanvas = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Transition$1, { in: _visible, timeout: 300, onEntered: function () { var _a; return (_a = offcanvasRef.current) === null || _a === void 0 ? void 0 : _a.focus(); } }, function (state) {
            return typeof window !== 'undefined' && portal
...
var CTabPane = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(Transition$1, { in: visible, timeout: 350 }, function (state) {
        var transitionClass = getTransitionClass(state);
...
var CToast = React.forwardRef(function (_a, ref) {
    ...
    var _className = classNames('toast fade', (_b = {
        ...
        _b['border-0'] = color,
        _b), className);
    return (React__default['default'].createElement(CSSTransition$1, { in: _visible, timeout: 250, onExit: function () { return onDismiss && onDismiss(index ? index : null); }, unmountOnExit: true },
    ...
    return (React__default['default'].createElement(CCard, __assign({ className: _className }, rest, { ref: ref }),
        React__default['default'].createElement(CCardBody, { className: "pb-0 d-flex justify-content-between align-items-start" },
            React__default['default'].createElement("div", null,
                value && (React__default['default'].createElement("div", { className: "fs-4 fw-semibold" },
                    value,
                    " ",
                    change && React__default['default'].createElement("span", { className: "fs-6 fw-normal" }, change))),
...
var CWidgetProgress = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CCard, __assign({ className: className, color: color, textColor: textColor }, rest, { ref: ref }),
        React__default['default'].createElement(CCardBody, null,
            ...
            text && (React__default['default'].createElement("small", { className: textColor === 'white' ? 'text-medium-emphasis-inverse' : 'text-medium-emphasis' }, text)))));
});
